...
import sexy.kostya.animatron.util.output.StringBuilderWriter;
...
public class IOUtils
{
    ...
    public static InputStream toBufferedInputStream(final InputStream input) throws IOException {
        return sexy.kostya.animatron.util.output.ByteArrayOutputStream.toBufferedInputStream(input);
    }
